import { ChangeDetectionStrategy, Component, inject, resource, signal, ViewEncapsulation } from '@angular/core';
import { FormsModule } from '@angular/forms';
import { TranslateModule, TranslatePipe } from '@ngx-translate/core';
import {
	EnumColumn, EnumMultiSelectComponent,
	HIGHWAY_TYPES_TO_TRANSLATION, isEnumColumn, isNumberColumn, NumberColumn,
...
export class StreetListViewPage {
	...
	protected readonly _cols: Column[] = [
		...
		{ header: `${this._headerPrefix}.HIGHWAY_TYPE`, field: 'highway', enum: EHighwayTypes, translationMap: HIGHWAY_TYPES_TO_TRANSLATION } as EnumColumn<EHighwayTypes>,
		{ header: `${this._headerPrefix}.SCORE`, field: 'dangerousScore', min: 0, step: 0.05, sortable: true } as NumberColumn,
		{ header: `${this._headerPrefix}.RIDES`, field: 'numberOfRides', min: 0, step: 10, sortable: true } as NumberColumn,
		{ header: `${this._headerPrefix}.INCIDENTS`, field: 'numberOfIncidents', min: 0, step: 10, sortable: true  } as NumberColumn,
		{ header: `${this._headerPrefix}.WEEKDAY`, field: 'weekDay', enum: EWeekDays, translationMap: WEEK_DAYS_TO_TRANSLATION, sortable: true  } as EnumColumn<EWeekDays>,
		{ header: `${this._headerPrefix}.TRAFFIC_TIME`, field: 'trafficTime', enum: ETrafficTimes, translationMap: TRAFFIC_TIMES_TO_TRANSLATION, sortable: true  } as EnumColumn<ETrafficTimes>,
	];
